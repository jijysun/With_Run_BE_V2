...
import UMC_8th.With_Run.domain.user.dto.UserRequestDto.ProfileImageRequest;
...
import UMC_8th.With_Run.domain.user.dto.UserResponseDto.FollowerListResultDTO;
import UMC_8th.With_Run.domain.user.dto.UserResponseDto.FollowingListResultDTO;
import UMC_8th.With_Run.domain.user.dto.UserResponseDto.LikeListResultDTO;
import UMC_8th.With_Run.domain.user.dto.UserResponseDto.ProfileResultDTO;
...
import UMC_8th.With_Run.domain.user.dto.UserResponseDto.SimpleUserResultDTO;
import UMC_8th.With_Run.domain.user.service.FollowService;
import UMC_8th.With_Run.domain.user.service.LikesService;
import UMC_8th.With_Run.domain.user.service.MyCourseService;
import UMC_8th.With_Run.domain.user.service.ProfileService;
import UMC_8th.With_Run.domain.user.service.ScrapService;
